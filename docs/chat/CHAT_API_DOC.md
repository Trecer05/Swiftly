...
**Описание:** Получение общей статистики команды.
**Возможные коды ответа:**
- `200` - успешное получение статистики
- `401` - не авторизован
...
#### POST /team/{team_id}/user/{username}/add
**Описание:** Добавление пользователя в команду.
**Параметры URL:**
- `team_id` - ID команды
- `username` - имя пользователя

**Возможные коды ответа:**
- `200` - Успешное добавление пользователя
...
#### DELETE /team/{team_id}/user/{user_id}/remove
**Описание:** Удаление пользователя из команды.
**Параметры URL:**
- `team_id` - ID команды
...
#### PUT /team/{team_id}/user/{user_id}/role
**Описание:** Обновление роли пользователя в команде.
**Параметры URL:**
- `team_id` - ID команды
- `user_id` - ID пользователя
...
#### PUT /team/{team_id}/edit
**Описание:** Обновляет информацию о команде.
**Параметры URL:**
- `team_id` - ID команды
**Параметры запроса:**
```json
{
    "id": "ID команды",
    "owner_id": "ID владельца команды",
    "name,omitempty": "Название команды",
    "description,omitempty": "Описание команды",
}
```
...
#### DELETE /team/{team_id}
**Описание:** Удаляет команду по ID.
**Параметры URL:**
- `team_id` - ID команды

**Возможные коды ответа:**
- `204` - Команда успешно удалена
- `401` - Неавторизованный запрос
- `403` - Доступ запрещен
- `404` - Команда не найдена
- `500` - Внутренняя ошибка сервера
...
#### GET /team/{team_id}
**Описание:** Возвращает информацию о команде по ID.
**Параметры URL:**
- `team_id` - ID команды

**Возможные коды ответа:**
- `200` - Команда успешно найдена
- `401` - Неавторизованный запрос
- `403` - Доступ запрещен
- `404` - Команда не найдена
- `500` - Внутренняя ошибка сервера
