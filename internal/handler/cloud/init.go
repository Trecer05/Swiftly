...
func InitCloudRoutes(r *mux.Router, manager *manager.Manager, rds *redis.WebSocketManager, kafkaManager *kafkaManager.KafkaManager) {
	...
	apiSecure.HandleFunc("/team/{id}/file/{file_id}", func(w http.ResponseWriter, r *http.Request) {
		UpdateTeamFileByIDHandler(w, r, manager, rds)
	...
	apiSecure.HandleFunc("/team/{id}/file/{file_id}", func(w http.ResponseWriter, r *http.Request) {
		DeleteTeamFileByIDHandler(w, r, manager, rds)
	...
	apiSecure.HandleFunc("/team/{id}/file/{file_id}/name", func(w http.ResponseWriter, r *http.Request) {
		UpdateTeamFileNameByIDHandler(w, r, manager, rds)
	}).Methods(http.MethodPut)
	...
	apiSecure.HandleFunc("/team/{id}/file/{file_id}/share", func(w http.ResponseWriter, r *http.Request) {
		ShareTeamFileByIDHandler(w, r, manager)
	...
	apiSecure.HandleFunc("/team/{id}/folder", func(w http.ResponseWriter, r *http.Request) {
		CreateTeamFolderHandler(w, r, manager, rds)
	}).Methods(http.MethodPost)
	...
	apiSecure.HandleFunc("/team/{id}/folder/{folder_id}", func(w http.ResponseWriter, r *http.Request) {
		GetTeamFolderFilesByIDHandler(w, r, manager)
	}).Methods(http.MethodGet)
	...
	apiSecure.HandleFunc("/team/{id}/folder/{folder_id}", func(w http.ResponseWriter, r *http.Request) {
		DeleteTeamFolderByIDHandler(w, r, manager, rds)
	}).Methods(http.MethodDelete)
	...
	apiSecure.HandleFunc("/team/{id}/folder/{folder_id}/share", func(w http.ResponseWriter, r *http.Request) {
	...
	apiSecure.HandleFunc("/team/{id}/folder/{folder_id}/name", func(w http.ResponseWriter, r *http.Request) {
		UpdateTeamFolderNameByIDHandler(w, r, manager, rds)
	}).Methods(http.MethodPut)
	...
	apiSecure.HandleFunc("/team/{id}/folder/{folder_id}/move", func(w http.ResponseWriter, r *http.Request) {
		MoveTeamFolderByIDHandler(w, r, manager, rds)
	}).Methods(http.MethodPut)
